  ...
  return (
    <>
      <div className={`marketplaceSidebar_collapse`}>
        ...
        {/* community sidebar */}
        <h4 className="my-4 text-3xl">Community</h4>
        <Collapse
          defaultActiveKey={['1']}
          onChange={onChangePanel}
          expandIconPosition="end">
          <Panel header="Years of Created" key="1">
            <div>
              <Checkbox.Group onChange={onChangeCheck}>
                <div className="flex flex-col items-start gap-y-4">
                  <Checkbox
                    value="lessThan_1year"
                    defaultChecked={true}
                    className="!ml-0">
                    <p className="text-base font-normal text-black">
                      Less than 1 year
                  ...
                  <Checkbox value="1-2years" className="!ml-0">
                    <p className="text-base font-normal text-black">
                      1 to 2 years (124)
                    </p>
                  </Checkbox>
                  <Checkbox value="3-5years" className="!ml-0">
                    <p className="text-base font-normal text-black">
                      3 to 5 years (542)
                    </p>
                  </Checkbox>
                  <Checkbox value="10years+" className="!ml-0">
                    <p className="text-base font-normal text-black">
                      More than 10+ years
                    </p>
                  </Checkbox>
